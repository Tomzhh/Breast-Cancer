...
st.sidebar.image("SOB_M_DC-14-5287-200-002.png", use_column_width=True)
# # Using object notation
# add_selectbox = st.sidebar.selectbox(
#     "Прошли ли Вы осмотр у врача?",
#     ("Да", "Нет", "Планирую")
# )
st.sidebar. write ("Мы использовали набор открытых данных **Breast Histopathology Images**.")
...
st.title("Определение рака молочной железы на основе гистопатологических данных с использованием обученных нами нейронных сетей")
st.subheader("""
         **Загрузите гистопатологическое изображение ткани молочной железы**, и наше приложение сделает классификацию снимков, указывающее, обнаружен ли в ней рак (`1`) или нет (`0`).
                                                                                                                                                              """)
